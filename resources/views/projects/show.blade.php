...
@section('content')
    <div class="container-fluid col-md-10">
        ...
        <div class="row">
            <div>
                <a class="btn btn-primary mr-2 ml-2" href="{{ route('projects.index') }}" title="Go back">
                    <i class="fas fa-backward "></i></a>
            </div>
            <div>
                <a class="btn btn-primary" href="{{ route('tasks.create', $project->id) }}" title="Crear tarea">
        ...
        <div class="border border-secondary mb-2 mt-2 p-2">
